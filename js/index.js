        ...
        success:function(res){
            ...
            //     }
                ...
                $(".foodBox").on("click",function(){ 
                    ...
                    if(goods[num2].foods[num1].oldPrice==""){
                        oMoney="";
                    }else{
                        oMoney="<i>¥</i> ";
                    }
                    oSingle += "<img src='"+goods[num2].foods[num1].image+"' class='singleImg'>"
                    oSingle += "<div class='singleHead'><p>"+
                             goods[num2].foods[num1].name+"</p><p><span>月售"+goods[num2].foods[num1].sellCount+"份</span><span>好评率"+
                             goods[num2].foods[num1].rating+"%</span></p><div class='singleCon'><div class='singleConTop'><span>¥<i>"+
                             goods[num2].foods[num1].price+"</i></span><span><del> <i>"+goods[num2].foods[num1].oldPrice+"</i></del></span></div><div class='singleConBot'>加入购物车</div></div></div><div class='singleBg'></div>"
                    oSingle += "<div class='singleInfos'><h4>商品介绍</h4><p>"+goods[num2].foods[num1].info+"</p></div><div class='singleBg'></div>"
                    oSingle += "<div class='singleAss'><h4>商品评价</h4><div class='singleAssTop'><span>全部<i>57</i></span><span>满意<i>47</i></span><span>不满意<i>10</i></span></div><div class='singleAssBot'><span class='iconfont icon-duigou '></span><span>只看有内容的评价</span></div></div>"
                    oSingle += "<div class='singleDel iconfont icon-clear-d7d8d9'></div>"
                    oSingle += "<ul class='singleList'>"
                            for(var j=0;j<goods[num2].foods[num1].ratings.length;j++){
                                oSingle += "<li><div class='singleFir'><div><span>2016-07-07</span><span>12:34</span></div><div><span>"+goods[num2].foods[num1].ratings[j].username+
                                "</span><img src='"+goods[num2].foods[num1].ratings[j].avatar+"'></div></div><div class='singleSec'><span class='iconfont icon-cai'></span><span>"+goods[num2].foods[num1].ratings[j].text+"</span></div>"
                                oSingle += "</li>"
                            }
                            oSingle += "</ul>"
